...
class Ros_Agent:
    def __init__(self,sub_topic):
        ...
        self.gen=bag.read_messages(topics=sub_topic["im"])
...
if __name__=='__main__':
    ...
    bag_path='/home/arash/catkin_ws/bagfiles/roboroyal/2022-03-18-22-11-04_one-hour-crop-with-homography-and-camera-info.bag'
    sub_topic={"im" : sys.argv[3][sys.argv[3].index("=")+1:]}
